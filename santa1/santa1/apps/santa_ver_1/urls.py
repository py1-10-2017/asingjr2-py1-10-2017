...
urlpatterns= [
    ...
    url(r'^ss_list$', views.ss_list, name='ss_list'),
    url(r'^enter_members$', views.enter_members, name = 'enter_members'),
    url(r'^(?P<list_id>\d+)/add_member$', views.add_member, name='add_member'),
    ...
    url(r'^(?P<list_id>\d+)/ss_list$', views.ss_list, name='ss_list'),
